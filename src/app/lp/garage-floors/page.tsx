...
export const metadata: Metadata = {
  ...
  description:
    "Transform your garage in 1-2 days. Epoxy or polyurea basecoat with a polyaspartic topcoat — chosen for what your concrete needs. Simiron-authorized. 94 five-star reviews. Premium workmanship warranty. Free estimate. (805) 952-5301.",
